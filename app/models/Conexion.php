...
//a la base de datos, esta calse, brindará este acceso.
class Conexion{
  ...
  public function getConexion(){
    // Es un manejador de excepciones
    //try (intentar)
    //catch (accidente, error)
    try{
      //La clase PDO te permite conectarte a diferentes motores de BD,
